    ...
    if (flashMessage && flashToken) {
        ...
        if (!processedTokens.includes(token)) {
            ...
            if (typeof Swal !== 'undefined') {
                ...
                } else if (message.includes('enlace de recuperación') || message.includes('password reset link')) {
                    title = '¡Éxito!';
                    customMessage = 'Se envió un email a tu bandeja de correo';
                    confirmButtonText = 'Entendido';
                } else if (message.includes('password reset link')) {
                    title = '¡Éxito!';
                    customMessage = 'Se envió un email a tu bandeja de correo';
                    confirmButtonText = 'Entendido';
                }
